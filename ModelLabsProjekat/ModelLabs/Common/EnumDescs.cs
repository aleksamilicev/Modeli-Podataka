...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.CURVE_X_MULTIPLIER, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.CURVE_X_UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.CURVE_Y1_MULTIPLIER, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.CURVE_Y1_UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.CURVE_Y2_MULTIPLIER, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.CURVE_Y2_UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.CURVE_Y3_MULTIPLIER, typeof(UnitMultiplier));
